...
import org.morphix.ConverterBuilder.Constants;
 ...
 * <p>
 * The default configuration is used when no parameterized types
 * are converted so no extra instantiation of field handlers are needed.
 * <p>
 * TODO: add builder so that we can build a configuration with any parameters and
 * the ones that weren't supplied will fallback to the defaults
 * <p>
...
public final class Configuration {
	...
	/**
	 * Builds a configuration object with the given parameters.
	 * When a type is provided the configuration will never be a default one.
	 *
	 * @param excludedFields excluded fields
	 * @param expandableFields expandable fields
	 * @param simpleConverters simple converters
	...
	public static class Default {
		...
		private static final List<Strategy> STRATEGIES = DefaultStrategies.STRATEGIES_LIST;
