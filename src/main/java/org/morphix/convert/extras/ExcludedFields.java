 ...
 * <p>
 * When construction this object the <code>excludedFieldNames</code> list parameter has the following conventions:
 * <ul>
...
public class ExcludedFields {
	...
	/**
	 * {@link ExcludedFields} object with no excluded fields list which will result in no fields excluded.
	 */
	private static final ExcludedFields EXCLUDE_NONE = new ExcludedFields(null);

	/**
	 * {@link ExcludedFields} object with empty excluded fields list which will result in all fields excluded.
	 */
	 ...
	 *
	 * <p>
	 * The <code>excludedFieldNames</code> list parameter has the following conventions:
	 * <ul>
	 * <li><code>null</code> - no fields will be excluded</li>
	 * <li>empty list - all fields will be excluded</li>
	 * <li>non-empty list - only the fields present in the list will be excluded all others will be converted</li>
	 ...
	 */
	public boolean shouldExcludeField(final ExtendedField field) {
