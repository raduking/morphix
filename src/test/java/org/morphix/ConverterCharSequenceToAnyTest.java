...
/**
 * Tests conversion from {@link CharSequence} / {@link String} to any class that
 * has a corresponding public static method.
 *
 * @author Radu Sebastian LAZIN
 *
 */
class ConverterCharSequenceToAnyTest {
	...
	void shouldFailIfParseMethodFails() {
		...
		assertThrows(ConverterException.class, () -> convertFrom(c, D::new));
	}
