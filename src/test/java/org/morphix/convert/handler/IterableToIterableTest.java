...
/**
 * Test class for {@link IterableToIterable}.
 *
...
class IterableToIterableTest {
	...
	void shouldFailIfConstructorForListElementsIsUnavailable() {
		...
		assertThrows(ObjectConverterException.class, () -> convertFrom(src, DestinationFail::new));
	}
	...
	void shouldFailIfConstructorForListElementsFails() {
		...
		assertThrows(ObjectConverterException.class, () -> convertFrom(src, DestinationWithList::new));
	}
	...
	void shouldFailOnGenericTypedLists() {
		...
		assertThrows(ObjectConverterException.class, () -> convertFrom(src, DestinationWithGenerics::new));
	}
